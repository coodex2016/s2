...
(i18nConf['langs'] || ['zh-CN']).forEach((value, index, array) => {
    let proI18n = require(`../src/products/${env}/i18n/${value}.json`);
    let commonI18n = require(`../src/commons/s2/i18n/${value}.json`);
    let moduleI18n = {};
    i18nConf['modules'].forEach((module, i) => {
        let cModuleI18n = require(`../src/modules/${module}/i18n/${value}.json`);
